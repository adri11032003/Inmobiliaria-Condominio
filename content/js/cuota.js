document.getElementById("enviar").onclick = function (){
    ...
    datos.append('id_pagos', $('#id_pagos').val());
    datos.append('id_inmobiliaria', $('#id_inmobiliaria').val());
    enviaAjax(datos);
};
...
function limpiar(){
  ...
  document.getElementById("sid_pagos").innerText = "";
  document.getElementById("sid_inmobiliaria").innerText = "";
}
...
function mostrar(datos){
  $.ajax({
    ...
    success: (response) => {
      ...
      $("#fecha").val(res.fecha);
      $("#monto").val(res.monto);
      $("#id_pagos").val(res.id_pagos);
      $("#id_inmobiliaria").val(res.id_inmobiliaria);
