...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Image('tc.png', 185, 5, 20); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
      ...
      /* CAMPOS DE LA TABLA */
      //color
      $this->SetFillColor( 41, 136, 236 ); //colorFondo
...
$pdf->Output('Prueba.pdf', 'I');//nombre de documento ya Descargado, Visor(I->visualizar - D->descargar)
