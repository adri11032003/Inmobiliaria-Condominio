                    ...
                    <div class="col-md-12">
                        <div class="container">
                            <div class="card">
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form method="post" action="reporte-propietario">
                                        <input type="submit" class="btn btn-dark" name="generar_pdf" value="Generar PDF">
                                    </form>
                                    <form method="post" action="reporte-pagosrecibidos">
                                        <input type="submit" class="btn btn-dark" name="generar1_pdf" value="Generar tipopago PDF">
                                    </form>
                                </div>
                                <!-- /.card-body -->
                            </div>
