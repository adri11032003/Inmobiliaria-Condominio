...
if (isset($_POST['generar_pdf'])) {
    ...
    $propietarios = $propietario->listar11();
   
    // Eliminar la verificación if ($propietarios->propietario > 0) ya que $propietarios es un array
    
    $total_propietarios = count($propietarios); // Contar el número total de propietarios
    ...
    $pdf->Cell(35,5, utf8_decode('Cédula'), 1, 0, 'C');
    ...
    foreach ($propietarios as $propietario) {
        $pdf->Cell(35,5, $propietario['cedula'], 1, 0);
    ...
    // Mostrar el total de propietarios
    $pdf->SetFont('Arial','B',9);
    
    $pdf->Cell(35,5, 'Total de propietarios:', 1, 0, 'L');
    $pdf->Cell(35,5, $total_propietarios, 1, 1, 'C');
